...
class UserSerializer(serializers.ModelSerializer):
    """Basic user info — used for registration and as nested read in messages/chats."""
...
class UserProfileSerializer(serializers.ModelSerializer):
    """Profile view/edit — includes description, pfp. role/username/email are read-only."""
    rating = serializers.SerializerMethodField()
